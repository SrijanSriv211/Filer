def base10_to_base64(decimal_number, precision=8):
    ...
    whole_base64 = base10_integer_to_base64(whole_part)

    # Convert fractional part to base 64
    fractional_base64 = base10_fraction_to_base64(fractional_part, precision)
...
def base64_to_base10(base64_string):
    ...
    whole_part = base64_integer_to_base10(parts[0])
    fractional_part = base64_fraction_to_base10(parts[1])
